...
- [ ] **VISUAL-01**: Apply a dark/neutral color scheme across the entire site — dark background, light text, minimal accent colors
- [ ] **VISUAL-02**: Use classic resume typography — serif or clean professional fonts appropriate for a CV
- [ ] **VISUAL-03**: Redesign homepage to single-column layout with professional resume-style spacing
- [ ] **VISUAL-04**: Ensure high readability and accessibility with proper contrast ratios

### Homepage

- [ ] **HOME-01**: Replace current two-column layout with single-column classic resume flow
- [ ] **HOME-02**: Display name, title, and professional summary/bio at the top
- [ ] **HOME-03**: Show work experience in a clear chronological resume format
- [ ] **HOME-04**: Fix invalid HTML nesting (current `<li>` inside `<li>` issue in `Home.astro`)
- [ ] **HOME-05**: Integrate social links (LinkedIn, GitHub) into the header or a dedicated contact bar
...
- [ ] **HEADER-01**: Redesign header to match dark/neutral theme, include nav and contact links
- [ ] **HEADER-02**: Ensure nav links are correct (Home, Projects, About all resolve)
- [ ] **FOOTER-01**: Remove Supabase credit from footer (not actually used)
- [ ] **FOOTER-02**: Redesign footer to match dark/neutral theme
...
| VISUAL-04 | Phase 1 / Phase 3 | Pending |
...
| HEADER-01 | Phase 1 | Pending |
| HEADER-02 | Phase 1 | Pending |
| FOOTER-01 | Phase 1 | Pending |
| FOOTER-02 | Phase 1 | Pending |
